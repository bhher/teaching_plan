...
<script type="text/javascript">
    function checkMember() {
        ...
        // ========== 정규식 패턴 정의 ==========
        // ✅ 수정: 파이프(|) 제거
        var regExpId = /^[a-zA-Z가-힣]/;  // 영문 또는 한글로 시작
        var regExpName = /^[가-힣]+$/;    // 한글만, 1개 이상 (+ 사용)
        var regExpPasswd = /^[0-9]+$/;    // 숫자만, 1개 이상 (+ 사용)
        ...
        if (!regExpPhone.test(phone)) {  // ✅ 변수명 수정
...
<body>
	<div class="container">
		...
		<form name="Member" action="validation05_process.jsp" method="post" 
			...
			<p><input type="submit" value="가입하기" class="btn">
		</form>
	</div>
</body>
</html>
